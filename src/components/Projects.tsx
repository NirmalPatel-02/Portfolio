  ...
  const projects = [
    {
      ...
      demoLink: "https://nirmal-patel-oldcarpriceprediction.hf.space/",
      codeLink: "https://huggingface.co/spaces/Nirmal-Patel/OldCarPricePrediction/tree/main",
    },
    {
      title: "CampusHire Predictor",
      description: "Classification model predicting student placement probability using academic data.",
      tools: ["Python", "TensorFlow", "Scikit-learn", "Pandas", "Matplotlib" , "FastAPI"],
      demoLink: "https://nirmal-patel-placementpredicter.hf.space/",
      codeLink: "https://huggingface.co/spaces/Nirmal-Patel/PlacementPredicter/tree/main",
    },
    {
