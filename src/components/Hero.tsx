        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6 animate-fade-in-up">
            <h1 className="font-heading text-5xl md:text-7xl font-bold">
              <span className="glow-text">Patel Nirmal N.</span>
            </h1>
          ...
          <div className="flex justify-center lg:justify-end">
            <div className="relative animate-float">
              <div className="absolute inset-0 bg-gradient-to-r from-primary to-accent-purple rounded-full blur-2xl opacity-50 animate-pulse" />
              <img 
                src={profilePhoto} 
                alt="Patel Nirmal N." 
                className="relative w-64 h-64 md:w-80 md:h-80 lg:w-96 lg:h-96 rounded-full object-cover border-4 border-primary/50 shadow-2xl"
              />
            </div>
          </div>
        </div>
